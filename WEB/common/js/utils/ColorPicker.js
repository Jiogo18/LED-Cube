...
export function getRandomColor(options = { hue: randInt(0, 360), saturation: randInt(50, 100), lightness: randInt(40, 60) }) {
	return hslToHex(options.hue, options.saturation, options.lightness);
}
